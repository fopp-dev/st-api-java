...
public interface UserMapper {
    ...
    User emailLogin(@Param("email") String paramString1, @Param("userPwd") String paramString2);
    ...
    List listByAdmin(@Param("realName") String paramString1, @Param("phone") String paramString2, @Param("searchId") Integer paramInteger1, @Param("accountType") Integer paramInteger2, @Param("isActive") Integer paramInteger3);
    List abstractListByAdmin(@Param("realName") String paramString1, @Param("userId") String paramString2, @Param("searchId") Integer paramInteger1, @Param("accountType") Integer paramInteger2, @Param("startTime") Date startTime, @Param("endTime") Date endTime);
