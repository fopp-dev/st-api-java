...
@Controller
@RequestMapping({"/user/ggPosition/"})
public class UserGgPositionController {
    private static final Logger log = LoggerFactory.getLogger(UserGgPositionController.class);

    @Autowired
    IUserGgPositionService iUserPositionService;
