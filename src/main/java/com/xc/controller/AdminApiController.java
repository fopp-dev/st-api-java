...
public class AdminApiController {
    ...
    @Autowired
    ISitePriceSettingService iSitePriceSettingService;
    ...
    //查询港股风控设置 股票分控信息
    @RequestMapping({"getHksSetting.do"})
    @ResponseBody
    public ServerResponse getHksSetting() {
        return ServerResponse.createBySuccess(this.iSiteHksSettingService.getSiteHksSetting());
    }
    ...
    // 查询行情设置列表
    @RequestMapping({"getSitePriceList.do"})
    @ResponseBody
    public ServerResponse getSitePriceList(int pageNum, int pageSize, String type) {
        return this.iSitePriceSettingService.listByAdmin();
    }

    // 添加行情设置
    @RequestMapping({"addSitePrice.do"})
    @ResponseBody
    public ServerResponse addSitePrice() {
        return ServerResponse.createBySuccess();
    }

    // 修改行情设置
    @RequestMapping({"updateSitePrice.do"})
    @ResponseBody
    public ServerResponse updateSitePrice() {
        return ServerResponse.createBySuccess();
    }
