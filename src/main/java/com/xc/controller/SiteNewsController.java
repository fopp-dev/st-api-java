...
public class SiteNewsController {
    ...
    //新闻资讯-港股列表查询
    @RequestMapping({"getGgPositionTop.do"})
    @ResponseBody
    public ServerResponse findGgPositionTopList(@RequestParam(value = "pageSize", defaultValue = "15") int pageSize) {
        return this.iUserGgPositionService.findPositionTopList(pageSize);
    }
