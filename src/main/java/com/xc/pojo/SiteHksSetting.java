...
public class SiteHksSetting {
    ...
    public  void  setFundingLevel(Integer fundingLevel){this.fundingLevel = fundingLevel;}
    ...
    public Integer getFundingLevel(){return  this.fundingLevel;}
