...
public class User {
    ...
    private BigDecimal userStockACapital; // A股本金

    private BigDecimal userStockHKCapital; // 港股本金

    private BigDecimal userStockAOcapital; // A股本金原始

    private BigDecimal userStockHKOcapital; // 港股本金原始

    private BigDecimal userStockAGiveCapital; // A股赠送本金

    public BigDecimal getUserStockAOcapital() {
        return userStockAOcapital;
    }

    public void setUserStockAOcapital(BigDecimal userStockAOcapital) {
        this.userStockAOcapital = userStockAOcapital;
    }

    public BigDecimal getUserStockHKOcapital() {
        return userStockHKOcapital;
    }

    public void setUserStockHKOcapital(BigDecimal userStockHKOcapital) {
        this.userStockHKOcapital = userStockHKOcapital;
    }

    public BigDecimal getUserStockACapital() {
        return userStockACapital;
    }

    public void setUserStockACapital(BigDecimal userStockACapital) {
        this.userStockACapital = userStockACapital;
    }

    public BigDecimal getUserStockHKCapital() {
        return userStockHKCapital;
    }

    public void setUserStockHKCapital(BigDecimal userStockHKCapital) {
        this.userStockHKCapital = userStockHKCapital;
    }
    ...
    public void setUserCapital(BigDecimal userCapital){this.userCapital = userCapital;}

    public void setUserHmt(BigDecimal userHmt ){this.userHmt = userHmt;}

    public void setEnableHmt(BigDecimal enableHmt){this.enableHmt = enableHmt;}
    ...
    public boolean equals(Object o) {
        ...
        Object this$userCapital = getUserCapital(), other$$userCapital = other.getUserCapital();
        if ((this$userCapital == null) ? (other$$userCapital != null) : !this$userCapital.equals(other$$userCapital)) return false;
        Object this$userHmt = getUserHmt(), other$$userHmt = other.getUserHmt();
        if ((this$userHmt == null) ? (other$$userHmt != null) : !this$userHmt.equals(other$$userHmt)) return false;
        Object this$enableHmt = getEnableHmt(), other$$enableHmt = other.getEnableHmt();
        if ((this$enableHmt == null) ? (other$$enableHmt != null) : !this$enableHmt.equals(other$$enableHmt)) return false;
    ...
    public int hashCode() {
        ...
        Object $userCapital = getUserCapital();
        result = result * 59 + (($userCapital == null) ? 43 : $userCapital.hashCode());
        Object $userHmt = getUserHmt();
        result = result * 59 + (($userHmt == null) ? 43 : $userHmt.hashCode());
        Object $enableHmt = getEnableHmt();
        result = result * 59 + (($enableHmt == null) ? 43 : $enableHmt.hashCode());
    ...
    public String toString() {
        return "User(id=" + getId() + ", agentId=" + getAgentId() + ", agentName=" + getAgentName() + ", phone=" + getPhone() + ", userPwd=" + getUserPwd() + ", withPwd=" + getWithPwd() + ", nickName=" + getNickName() + ", realName=" + getRealName() + ", idCard=" + getIdCard() + ", accountType=" + getAccountType() + ", userAmt=" + getUserAmt() + ", enableAmt=" + getEnableAmt() + ", sumChargeAmt=" + getSumChargeAmt() + ", sumBuyAmt=" + getSumBuyAmt() + ", recomPhone=" + getRecomPhone() + ", isLock=" + getIsLock() + ", isLogin=" + getIsLogin() + ", regTime=" + getRegTime() + ", regIp=" + getRegIp() + ", regAddress=" + getRegAddress() + ", img1Key=" + getImg1Key() + ", img2Key=" + getImg2Key() + ", img3Key=" + getImg3Key() + ", isActive=" + getIsActive() + ", authMsg=" + getAuthMsg() + ", userIndexAmt=" + getUserIndexAmt() + ", enableIndexAmt=" + getEnableIndexAmt() + ", userFutAmt=" + getUserFutAmt() + ", enableFutAmt=" + getEnableFutAmt() +", withdrawalPwd=" + getWithdrawalPwd() +", tradingAmount=" + getTradingAmount() + ")";
    }

    public User() {
    }

    @ConstructorProperties({"id", "agentId", "agentName","email", "phone", "userPwd", "withPwd", "nickName", "realName", "idCard", "accountType", "userCapital","userHmt","enableHmt","userAmt", "enableAmt", "sumChargeAmt", "sumBuyAmt", "recomPhone", "isLock", "isLogin", "regTime", "regIp", "regAddress", "img1Key", "img2Key", "img3Key", "isActive", "authMsg", "userIndexAmt", "enableIndexAmt", "userFutAmt", "enableFutAmt", "withdrawalPwd","tradingAmount","userStockACapital","userStockHKCapital","userStockAOcapital","userStockHKOcapital","userStockAGiveCapital"})
    public User(Integer id, Integer agentId, String agentName,  String email,String phone, String userPwd, String withPwd, String nickName, String realName, String idCard, Integer accountType,BigDecimal userCapital ,BigDecimal userHmt,BigDecimal enableHmt, BigDecimal userAmt, BigDecimal enableAmt, BigDecimal sumChargeAmt, BigDecimal sumBuyAmt, String recomPhone, Integer isLock, Integer isLogin, Date regTime, String regIp, String regAddress, String img1Key, String img2Key, String img3Key, Integer isActive, String authMsg, BigDecimal userIndexAmt, BigDecimal enableIndexAmt, BigDecimal userFutAmt, BigDecimal enableFutAmt, String withdrawalPwd, BigDecimal tradingAmount, BigDecimal userStockACapital, BigDecimal userStockHKCapital,BigDecimal userStockAOcapital, BigDecimal userStockHKOcapital, BigDecimal userStockAGiveCapital) {
        this.id = id;
        this.agentId = agentId;
        this.agentName = agentName;
        this.email = email;
        ...
        this.userHmt = userHmt;
        this.enableHmt = enableHmt;
        this.userAmt = userAmt;
        this.enableAmt = enableAmt;
        this.sumChargeAmt = sumChargeAmt;
        this.sumBuyAmt = sumBuyAmt;
        ...
        this.userStockAOcapital = userStockAOcapital;
        this.userStockHKOcapital = userStockHKOcapital;
        this.userStockAGiveCapital = userStockAGiveCapital;
    }
    ...
    public BigDecimal getUserCapital(){return this.userCapital;}

    public BigDecimal getUserHmt(){return this.userHmt;}

    public BigDecimal getEnableHmt(){return this.enableHmt;}
    ...
    public void setUserStockAGiveCapital(BigDecimal userStockAGiveCapital) {
        this.userStockAGiveCapital = userStockAGiveCapital;
    }

    public BigDecimal getUserStockAGiveCapital() {
        return userStockAGiveCapital;
    }
}
