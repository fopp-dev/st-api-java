...
public class SitePay {
    ...
    public void setTotalAllowPay(BigDecimal totalAllowPay){this.totalAllowPay = totalAllowPay;}

    public void setServerCharge(BigDecimal serverCharge){this.serverCharge = serverCharge;}
    ...
    @ConstructorProperties({"id", "cType", "formUrl", "formCode", "channelType", "channelName", "channelDesc", "channelAccount", "channelImg", "channelMinLimit", "channelMaxLimit", "isShow", "isLock","totalPrice","totalAllowPay","serverCharge"})
    public SitePay(Integer id, Integer cType, String formUrl, String formCode, String channelType, String channelName, String channelDesc, String channelAccount, String channelImg, Integer channelMinLimit, Integer channelMaxLimit, Integer isShow, Integer isLock, BigDecimal totalPrice, BigDecimal totalAllowPay, BigDecimal serverCharge) {
        this.id = id;
        this.cType = cType;
        this.formUrl = formUrl;
        this.formCode = formCode;
        ...
        this.totalAllowPay = totalAllowPay;
    ...
    public BigDecimal getTotalAllowPay(){return this.totalAllowPay;}

    public BigDecimal getServerCharge(){return  this.serverCharge;}
}
