...
public class StockGgMarketsDay {
    private Integer id;
    ...
    public StockGgMarketsDay(Integer id, Integer stockId, String stockName, String stockCode, String stockGid, String ymd, String hms, BigDecimal nowPrice, BigDecimal creaseRate, String openPx, String closePx, String businessBalance, String businessAmount, Date addTime, String addTimeStr) {
        this.id = id;
        this.stockId = stockId;
        this.stockName = stockName;
        this.stockCode = stockCode;
