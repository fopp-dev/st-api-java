...
public class UserInfoVO {
    ...
    private BigDecimal allGgProfitAndLose;
    private BigDecimal allFreezhmt;
    ...
    private Integer hFundingLevel;

    private Integer aFundingLevel;

    private BigDecimal userHmtMulRate;

    private BigDecimal noTransHmt;

    private BigDecimal noTransAmt;

    //港股固定汇率
    private BigDecimal fixedHRate;

    //港股实时汇率
    private  BigDecimal realHRate;
    ...
    // 赠送本金
    private BigDecimal userStockAGiveCapital;

    // 可划转本金
    private BigDecimal canWithdrawCapital;

    public BigDecimal getCanWithdrawCapital() {
        return canWithdrawCapital;
    }

    public void setCanWithdrawCapital(BigDecimal canWithdrawCapital) {
        this.canWithdrawCapital = canWithdrawCapital;
    }
    ...
    public void  setFixedHRate(BigDecimal fixedHRate){
        this.fixedHRate = fixedHRate;
    }

    public BigDecimal getFixedHRate(){return this.fixedHRate;}

    public  void  setRealHRate(BigDecimal realHRate){this.realHRate = realHRate;}

    public BigDecimal getRealHRate(){return  this.realHRate;}

    public  void  setDynamicState(Integer dynamicState){this.dynamicState = dynamicState;}

    public Integer getDynamicState(){return this.dynamicState;}

    public void  setNoTransHmt(BigDecimal noTransHmt){this.noTransHmt = noTransHmt;}
    public BigDecimal getNoTransHmt(){return this.noTransHmt;}

    public void  setNoTransAmt(BigDecimal noTransAmt){this.noTransAmt = noTransAmt;}
    public  BigDecimal getNoTransAmt(){return  this.noTransAmt;}


    public void setUserHmtMulRate(BigDecimal userHmtMulRate){
        this.userHmtMulRate = userHmtMulRate;
    }

    public BigDecimal getUserHmtMulRate(){return this.userHmtMulRate;}

    public  void sethFundingLevel(Integer hFundingLevel){this.hFundingLevel = hFundingLevel;}

    public void setaFundingLevel (Integer aFundingLevel){this.aFundingLevel = aFundingLevel;}

    public Integer gethFundingLevel(){return this.hFundingLevel;}

    public Integer getaFundingLevel(){return this.aFundingLevel;}
    ...
    public void  setAllGgProfitAndLose(BigDecimal allGgProfitAndLose){this.allGgProfitAndLose = allGgProfitAndLose;}

    public void  setAllFreezhmt(BigDecimal allFreezhmt){this.allFreezhmt = allFreezhmt;}
    ...
    public  BigDecimal getAllGgProfitAndLose(){return this.allGgProfitAndLose;}

    public  BigDecimal getAllFreezhmt(){return this.allFreezhmt;}
