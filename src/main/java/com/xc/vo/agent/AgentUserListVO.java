...
public class AgentUserListVO {
    ...
    public BigDecimal getUserHmt() {
        return userHmt;
    }

    public void setUserHmt(BigDecimal userHmt) {
        this.userHmt = userHmt;
    }

    public BigDecimal getEnableHmt() {
        return enableHmt;
    }

    public void setEnableHmt(BigDecimal enableHmt) {
