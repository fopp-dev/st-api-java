...
public class PositionVO {
    ...
    private BigDecimal allFree;

    private BigDecimal allPositPric;

    public void setAllPositPric(BigDecimal allPositPric){this.allPositPric = allPositPric;}

    public BigDecimal getAllPositPric(){return this.allPositPric;}

    public void setAllFree(BigDecimal allFree){this.allFree = allFree;}

    public BigDecimal getAllFree(){return this.allFree;}
