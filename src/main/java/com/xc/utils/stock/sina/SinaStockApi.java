...
public class SinaStockApi {
    ...
    // 通过行情获取所有股票
    public static ServerResponse getAllStockList(List<Stock> stockList){

        String url = "http://qt.gtimg.cn/q="; // 股票腾讯接口
        ...
        for (Stock stock : stockList) {
            ...
            stockNameArr.add(stock.getStockGid());

        }

        queryStocks = StringUtils.join(stockNameArr,',');
        ...
        try {
            ...
            stock_result = HttpClientRequest.doGet(url);



            strArr= stock_result.split(";");
        ...
        return ServerResponse.createBySuccess(strArr);
